...
export default function AppInstance(props: any) {
  ...
  return (
    <>
      <div
        class={`cursor-pointer flex justify-center items-start ${isShrink ? "hvr-pulse-shrink" : ""}`}
      ...
      >
        <div class={`flex flex-col items-center`}>
          ...
          <div class="app-name text-white text-base mt-1">{appInstance.instanceName}</div>
        </div>
